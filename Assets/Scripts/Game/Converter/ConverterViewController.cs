...
public class ConverterViewController : IConverterViewController, IInitializable, IDisposable
{
    ...
    public ConverterViewController(ConverterView view, Converter converter, IMoneySystem moneySystem)
    {
        _view = view;
    ...
    private void OnUnloadResourceRequested()
    {
        ...
        {
            UnityEngine.Debug.Log("Sell resource"); //не было в ГДД - just for fun
            _moneySystem.AddMoney(20);
        }
    }
